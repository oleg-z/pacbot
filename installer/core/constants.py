...
AWS_WITH_PROFILE = "4. Using provided AWS profile"
AWS_CHOOSE_AUTH_OPTION = "Type 1 or 2 or 3 or 4 to continue to create services in AWS: "
AWS_INCORRECT_MECHANISM = "Entered an incorrect value!!!"
AWS_AUTH_MECHANISM_NOT_SUPPLIED = "Please add value 1 or 2 or 3 or 4 for AWS_AUTH_MECHANISM in settings/local.py"
...
AWS_PROFILE_NOT_SUPPLIED = "Please enter value for AWS_PROFILE in settings/local.py file"
...
AWS_PROFILE_INPUT = "Enter AWS PROFILE to use: "
